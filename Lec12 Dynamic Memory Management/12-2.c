...
void init(int**** ptr) {
    ...
    /*ptr[0][1][0][0] = malloc(sizeof(int));
    ptr[0][1][1][0] = malloc(sizeof(int));
    ptr[0][0][0][0] = malloc(sizeof(int));
    ptr[0][0][1][0] = malloc(sizeof(int));
    ptr[1][1][0][0] = malloc(sizeof(int));
    ptr[1][1][1][0] = malloc(sizeof(int));
    ptr[1][0][0][0] = malloc(sizeof(int));
    ptr[1][0][1][0] = malloc(sizeof(int));
    ptr[0][1][0][1] = malloc(sizeof(int));
    ptr[0][1][1][1] = malloc(sizeof(int));
    ptr[0][0][0][1] = malloc(sizeof(int));
    ptr[0][0][1][1] = malloc(sizeof(int));
    ptr[1][1][0][1] = malloc(sizeof(int));
    ptr[1][1][1][1] = malloc(sizeof(int));
    ptr[1][0][0][1] = malloc(sizeof(int));
    ptr[1][0][1][1] = malloc(sizeof(int));*/
}